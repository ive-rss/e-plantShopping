...
function ProductList({ onHomeClick }) {
    ...
    useEffect(() => {
        const remaining = {};
        cartItems.forEach(item => remaining[item.name] = true);
        setAddedToCart(remaining);
    }, [cartItems]);
        ...
        <div>
            ...
            {!showCart ? (
                <div className="product-grid">
                    {plantsArray.map((category, indice) => {
                        return <div className="product-grid" key={indice}>
                            <h1 className='plant_heading'>
                                <div className='plantname_heading'>{category.category}</div>
                            </h1>
                            <div className="product-list">
                                {category.plants.map((plant, indice) => {
                                    return <div className="product-card" key={indice}>
